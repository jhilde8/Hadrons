...
MODULE_REGISTER_TMP(SaveBinnedA2AVecs128, ARG(TSaveBinnedA2AVecs<FIMPL, 128>), MIO);
...
MODULE_REGISTER_TMP(SaveBinnedA2AVecs221, ARG(TSaveBinnedA2AVecs<FIMPL, 221>), MIO);
